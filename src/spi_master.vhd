...
-- also provides the ability to load data into tx and rx buffers,
...
-- 27-07-26 | Roi López Barata  | Fixed order of the entering MISO and MOSI data in the rx and tx buffers.
